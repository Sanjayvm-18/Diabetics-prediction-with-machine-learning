...
if __name__ == '__main__':
    MODEL_PATH =  "C:\\Users\sanja\Downloads\logistic-regression-example-diabetes-detection-master\logistic-regression-example-diabetes-detection-master\models\logistic_reg.sav"
